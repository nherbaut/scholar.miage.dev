...
run:
	docker run --rm -p 8106:5000  -e SHLINK_API_KEY=${SHLINK_API_KEY} -e API_KEY=${API_KEY} -e PYALEX_EMAIL=nicolas.herbaut@u-bordeaux.fr --name "scpushack" nherbaut/scpushack:nextnet
stop:
